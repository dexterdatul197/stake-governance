  ...
  return (
    <>
      <svg {...returnSize(size)} viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
        <path
          d="M3.99976 18.0002L7.1633 14.8367L10.3269 18.0002L7.1633 21.1638L3.99976 18.0002Z"
          fill="#F3BA2F"
        />
        <path
        ...
        />
        <path
          d="M25.6719 18.0015L28.8354 14.8379L31.999 18.0015L28.8354 21.165L25.6719 18.0015Z"
          fill="#F3BA2F"
        />
        <path
